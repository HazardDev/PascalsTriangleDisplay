...
var AppComponent = (function () {
    ...
    AppComponent.prototype.calculateTriangle = function (size) {
        var theTriangle = [[1], [1, 1]];
...
module.exports = "<input [(ngModel)]=\"size\" type=\"number\">\n<button (click)=\"calculateTriangle(size)\">AWD</button>\n<div *ngFor=\"let item of triangle\">\n  {{item}}\n</div>"
